...
for (var i = 0; i < array_length_1d(tile_pos); i++) {
	...
	switch (rectangle_in_rectangle(tilex + xx, tiley + yy, tilex + 32 + xx, tiley + 32 + yy, global.border[0], global.border[3] - 512, global.border[1], global.border[2]))
	{
		case 0: { return true; } // Outside
		case 1: break; // Inside
		case 2: { return true; } // Overlapping
	}
}
return false;
