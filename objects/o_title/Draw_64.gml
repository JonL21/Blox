...
draw_text_colour(x + 2, y - 126, "BLOX", c_black, c_black, c_black, c_black, 0.5);
draw_text(x + 2, y - 128, "BLOX");
...
draw_text_colour(x + 2, room_height - 30, "MENU CONTROLS: Move Up - UP ARROW KEY, Move Down - DOWN ARROW KEY, Select - ENTER", c_black, c_black, c_black, c_black, 0.5);
draw_text(x + 2, room_height - 32, "MENU CONTROLS: Move Up - UP ARROW KEY, Move Down - DOWN ARROW KEY, Select - ENTER");